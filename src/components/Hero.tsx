...
const Hero: React.FC = () => {
    return (
        <>
            <section id="hero" className="min-h-dvh min-w-dvw flex items-center justify-center fixed z-[-100] ">
                <div id="hero-content" className="container mx-auto px-6 text-center">
                    ...
                    <h1 className="text-5xl sm:text-6xl text-gray-300 md:text-8xl lg:text-9xl font-display font-bold tracking-tight mb-6 md:mb-8 leading-tight">
                        Developing <br />
